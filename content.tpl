...
{{#channel}}
	{{^list_blocked}}
	<div class="channel-object" onclick="ajaxQuery('channel','wall',{{id}} , event)" data-id="{{id}}">
		<a class="prevent-link not-prevented" href="../channel{{id}}/wall">
			<div class="channel-cover" style="background:url('../{{cover}}');background-repeat:no-repeat;background-position: 50% 50%;background-size:cover;"></div>
			<div class="channel-img" style="background:url('../{{img}}');background-repeat:no-repeat;background-position: 50% 50%;background-size:cover;"></div>
			<div class="channel-name">{{name}}</div>
		</a>
	</div>
	{{/list_blocked}}
	{{#list_blocked}}
	<div class="channel-object block" data-id="{{id}}">
		<div class="content">
			<div class="alert-object-small">{{langs.privacy}}</div>
		</div>
	</div>
