		...
		<div class="news-content material-object">
			...
			<div class="news-header">
				...
				{{^author}}
					...
					{{/me}}
				{{/author}}
				<a class="prevent-link not-prevented" onclick="ajaxQuery( {{#author}}'channel'{{/author}}{{^author}}'user'{{/author}} , 'wall' , {{author_info.id}} , event )" href="../{{#author}}channel{{/author}}{{^author}}id{{/author}}{{author_info.id}}/wall">
