...
{{#channel}}
	...
	<script type="text/javascript">
		...
		fillDataTPL('../php_requests/get_content.php',{'content': 'channel', 'prof_id': profID },'fillUSER(\'channel\')');
	</script>
{{/channel}}
...
{{#news}}
				...
				<div class="options">
					<div class="author block bl0">
						...
						<div class="option opt3" onclick="modifyFeedWall( 0 , 2 )">
							<div class="icon"></div>
							<div class="title">{{langs.channels}}</div>
						</div>
					</div>
	...
	<script type="text/javascript">
		...
		fillDataTPL('../php_requests/get_content.php',{ 'content': 'suggestion', type : 'channels' , length: 3 }, 'fillJSON( \'.content-pages#news-page .feed-menu .suggestions .s-content.cl\')');
...
{{#search}}
	<div class="container">
		<div id="search-columns">
			...
			<div class="tab simple-btn-object" onclick="changeSearchTab(1)">{{langs.channels}}</div>
